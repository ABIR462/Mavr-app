...
var Route$2 = class Route extends BaseRoute {
  ...
  */
  constructor(options) {
    ...
    this.Link = f$1.forwardRef((props, ref) => {
...
const appCss = "/assets/styles-CU1bW38p.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "MAVR is India's first athlete operating system, offering a unified platform for training, nutrition, and community."
      },
      {
    ...
    scripts: [
      ...
      {
        children: "window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-XXXXXXXX');"
      }
    ]
  }),
...
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "MAVR is India's first complete athlete operating system. Track workouts, nutrition, connect with coaches, and earn achievements. Join the waitlist now."
    }, {
      name: "keywords",
      content: "Indian fitness app, athlete tracking app India, gym tracking app, trainer student app India, fitness app India"
    }, {
      property: "og:title",
      content: "MAVR — Train. Track. Dominate."
    }, {
      property: "og:description",
